        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Learn practical vocational skills from expert Nigerian instructors. 
                Build a career, start a business, or enhance your expertise.
              </motion.p>
                ...
                <motion.div variants={scaleInVariants}>
                  <Link to="/auth">
                    <Button 
                      size="lg" 
                      variant="outline" 
                      className="w-full sm:w-auto border-2 border-white text-white hover:bg-white hover:text-blue-600 group px-8 py-4 text-lg rounded-full font-semibold transition-all duration-300"
                    >
                      <motion.span
                        whileHover={{ scale: 1.05 }}
                        transition={{ type: "spring", stiffness: 400, damping: 10 }}
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                ...
                <motion.div 
                  className="text-gray-600 group-hover:text-gray-900 transition-colors font-medium"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Discover the skills that are in high demand in Nigeria's growing economy
            </p>
          </motion.div>
          ...
          >
            {COURSE_CATEGORIES.slice(0, 10).map((category, index) => (
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300, damping: 20 }}
              >
                <Card className="p-6 text-center cursor-pointer hover:shadow-xl transition-all duration-500 group relative overflow-hidden border-0 bg-white/80 backdrop-blur-sm">
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-green-500/10 opacity-0 group-hover:opacity-100"
                  ...
                  <h3 className="font-semibold text-gray-900 group-hover:text-blue-600 transition-colors relative z-10 text-sm">
                    {category}
                  </h3>
                </Card>
              </motion.div>
          ...
          >
            {featuredCourses.map((course, index) => (
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300, damping: 20 }}
              >
                <Card className="overflow-hidden hover:shadow-2xl transition-all duration-500 group relative border-0 bg-white/90 backdrop-blur-sm">
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-3">
                      <motion.span 
                        className="text-sm text-blue-600 font-semibold px-3 py-1 bg-blue-50 rounded-full"
                        whileHover={{ scale: 1.05 }}
                      >
                        {course.category}
                      </motion.span>
                    ...
                    <motion.div
                      ...
                      whileTap={{ scale: 0.98 }}
                    >
                      <Button className="w-full group relative overflow-hidden bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 rounded-xl py-3 font-semibold">
                        <motion.span
                          className="relative z-10"
                          whileHover={{ scale: 1.05 }}
                        >
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <motion.p 
              ...
              transition={{ delay: 0.2 }}
            >
              Join thousands of Nigerians who have already started their journey to success
            </motion.p>
