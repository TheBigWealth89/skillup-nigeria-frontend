...
const LearnerDashboard: React.FC = () => {
  const stats = [
    ...
    { title: 'Completed', value: '3', icon: CheckCircle, color: 'text-green-600' },
    { title: 'Certificates', value: '2', icon: Award, color: 'text-purple-600' },
    { title: 'Study Hours', value: '124', icon: Clock, color: 'text-orange-600' }
  ];
  ...
  const achievements = [
    { title: 'First Course Completed', description: 'Completed your first course', icon: '🎯' },
    { title: 'Quick Learner', description: 'Finished 3 lessons in one day', icon: '⚡' },
    { title: 'Certificate Earned', description: 'Earned Digital Marketing certificate', icon: '🏆' },
